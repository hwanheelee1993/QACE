...
'''
class VisualT5(T5PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.encoder = VisualT5Stack(encoder_config, self.shared)
...
class VisualT5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None):
        super().__init__(config)
        self.img_emb = nn.Linear(2054, config.d_model)
    ...
    def forward(
        ...
        img_embeds = self.img_emb(img_features)
        inputs_embeds = torch.cat((inputs_embeds, img_embeds), axis=1)
