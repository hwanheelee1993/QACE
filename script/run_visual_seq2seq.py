...
from visual_data_collator import visual_data_collator
from visual_t5 import VisualT5
from visual_t5 import VisualT5Stack
...
def main():
    ...
    '''
    model = VisualT5.from_pretrained(
        model_args.model_name_or_path,
        from_tf=bool(".ckpt" in model_args.model_name_or_path),
        config=config,
        cache_dir=model_args.cache_dir,
    ...
    # them all).
    source_lang, target_lang, text_column, summary_column, imgid_column = None, None, None, None, None
    ...
    def preprocess_function(examples):
        ...
        model_inputs["img_features"] = imgids
    ...
    data_collator = visual_data_collator
